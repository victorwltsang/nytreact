	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          'div',
	          { className: 'jumbotron jumbotron-colors' },
	          React.createElement(
	            'h1',
	            ...
	            React.createElement(
	              'strong',
	              null,
	              React.createElement('i', { className: 'fa fa-newspaper-o fa-padding-right' }),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Results = React.createClass({
	  ...
	  saveClicker: function saveClicker(result) {
	  ...
	  componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
	    ...
	    var myResults = nextProps.results.map(function (search, i) {
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          "button",
	          { type: "button", className: "btn btn-success panel-inner-button", onClick: saveArticle },
	          "Save"
	        )
	      );
	    });
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            "strong",
	            null,
	            React.createElement("i", { className: "fa fa-file-text-o fa-padding-right" }),
	            "Results"
	          )
	        )
	      ),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Saved = React.createClass({
		...
		deleteClicker: function deleteClicker(result) {
		...
		componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
			...
			var myResults = nextProps.savedArticles.map(function (search, i) {
				...
				return React.createElement(
					...
					React.createElement(
						"button",
						{ type: "button", className: "btn btn-danger panel-inner-button", onClick: deleteArticle },
						"Delete"
					)
				);
			});
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							"strong",
							null,
							React.createElement("i", { className: "fa fa-cloud-download fa-padding-right" }),
							"Saved Articles"
						)
					)
				),
	...
	var Search = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        "div",
	        { className: "panel-heading panel-heading-custom" },
	        React.createElement(
	          "h3",
	          { className: "panel-title" },
	          React.createElement(
	            "strong",
	            null,
	            React.createElement("i", { className: "fa  fa-search fa-padding-right" }),
	            "Search Parameters"
	          )
	        )
	      ),
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement("input", { type: "text", className: "form-control", id: "topic", onChange: this.handleChange, required: true }),
	            React.createElement("br", null),
	            React.createElement(
	              "h4",
	              { className: "" },
	            ...
	            React.createElement(
	              "button",
	              { type: "button", className: "btn btn-lg btn-primary", onClick: this.handleClick },
